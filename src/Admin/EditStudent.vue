            ...
            <form method="post" @submit.prevent="editinfo" id="frmDangKyThanhVien">
                ...
                <table border="1" width="800px" cellspacing="0" cellpadding="10px">
                    ...
                    <td colspan="2" align="center">
                        <li class="list-group-item active">CHỈNH SỬA THÔNG TIN NGƯỜI DÙNG</li>
                    </td>
                    <!-- Họ tên row - Start -->
                    <tr>
                        <td width="100px">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="txtHoTen" id="txtHoTen" required="required"
                                ...
                                title="Nhập họ tên phải viết hoa toàn bộ" v-model="Student.fullname" />
                        </td>
                    </tr>
                    <!-- Họ tên row - End -->
                    <!-- Mật khẩu row - Start -->
                    <tr>
                        ...
                        <td>
                            <select name="gt" id="gt" v-model="this.Student.gioitinh">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="date" name="numTuoi" id="numTuoi" v-model="this.Student.namsinh" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="tel" name="txtSoDienThoai" id="txtSoDienThoai" required="true" pattern="[0-9]{10,}"
                                ...
                                placeholder="Nhập 10 số trở lên xxxxxxxxxx" v-model="this.Student.phone" />
                        </td>
                    </tr>
                    ...
                    <tr @click="(e) => { e.preventDefault() }">
                        ...
                        <td>
                            <select @change="(e) => { this.setTp(e) }" class="form-select form-select-sm mb-3" id="city"
                                aria-label=".form-select-sm" v-model="this.Student.tp">
                                <option value="" selected>--Chọn tỉnh thành--</option>
                            </select><br>

                            <select @change="(e) => { this.setHuyen(e) }" class="form-select form-select-sm mb-3"
                                id="district" aria-label=".form-select-sm" v-model="this.Student.huyen">
                                <option value="" selected>--Chọn quận huyện--</option>
                            </select><br>

                            <select @change="(e) => { this.setXa(e) }" class="form-select form-select-sm" id="ward"
                                aria-label=".form-select-sm" v-model="this.Student.xa">
