            ...
            <form method="post" @submit.prevent="editinfo" id="frmDangKyThanhVien">
                ...
                <table border="1" width="800px" cellspacing="0" cellpadding="10px">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="gt" id="gt" v-model="this.Teacher.sex">
                    ...
                    <!-- <tr>
                        ...
                        <td>
                            <select name="" id="grade" v-model="this.Teacher.grade">
                    ...
                    <tr v-if="this.Teacher.grade!=''">
                        <td>
                            <label for="myclass">Lớp</label>
                        </td>
                        <td>
                            <select name="" v-model="Teacher.myclassID">
                    ...
                    <tr @click="(e) => { e.preventDefault() }">
                        ...
                        <td>
                            <select @change="(e) => { this.setTp(e) }" class="form-select form-select-sm mb-3" id="city"
                                aria-label=".form-select-sm" v-model="this.Teacher.tp">
                                <option value="" selected>--Chọn tỉnh thành--</option>
                            </select><br>

                            <select @change="(e) => { this.setHuyen(e) }" class="form-select form-select-sm mb-3"
                                id="district" aria-label=".form-select-sm" v-model="this.Teacher.huyen">
                                <option value="" selected>--Chọn quận huyện--</option>
                            </select><br>

                            <select @change="(e) => { this.setXa(e) }" class="form-select form-select-sm" id="ward"
                                aria-label=".form-select-sm" v-model="this.Teacher.xa">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <router-link class="btn btn-primary text-uppercase" to="/admin/list-editInfo">Quay
                                lại</router-link>
